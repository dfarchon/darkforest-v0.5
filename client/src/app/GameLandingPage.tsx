...
import { BLOCK_EXPLORER_URL, CHAIN_FACUET, CHAIN_NAME, TOKEN_NAME } from "../utils/constants";
  ...
  const advanceStateFromAccountSet = async () => {
    ...
    try {
      ...
      if (isWhitelisted) {
        ...
        terminalEmitter.println('Please send ' + TOKEN_NAME + ' on ' + CHAIN_NAME + ' to your burner account');
